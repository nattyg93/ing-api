...
ADMINS: List[Tuple[str, str]] = [("Nat Gordon", "nathanael.l.gordon@gmail.com")]
MANAGERS = ADMINS
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "common.pagination.JsonApiPageNumberPagination",
    "PAGE_SIZE": 100,
